...
// Register new user
router.post('/register', requireNoAuth, validateBody(registerSchema), async (req: Request, res: Response) => {
  try {
...
// Login user
router.post('/login', requireNoAuth, validateBody(loginSchema), async (req: Request, res: Response) => {
  try {
